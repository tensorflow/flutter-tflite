...
import 'package:image_segmentation/helper/ner_classifier.dart';
      ...
      body: TextButton(
          onPressed: () {
            List<Map<String, String>> data =
                nerClassifier.predict("88 Downtown Blvd, Austin, TX");

            debugPrint('recognizedtext extacted as: $data');
          },
          child: Text("dkkkkkk")),
    );
  }
